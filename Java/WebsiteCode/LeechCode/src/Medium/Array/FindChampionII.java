...
/**
 * <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/find-champion-ii/">2924. Find Champion II</a>
 * 
 * <div><div class="elfjS" data-track-load="description_content"><p>There are <code>n</code> teams numbered from <code>0</code> to <code>n - 1</code> in a tournament; each team is also a node in a <strong>DAG</strong>.</p>
 * 
...
public class FindChampionII {
    public static void main(String[] args) {
        ...
        for (int[][][] test : tests) {
            ...
            System.out.println(new FindChampionII_Solution().findChampion(n, edges));
        }
    }
}

// 4ms 46.20MB
class FindChampionII_Solution {
